...
export function AppHeader() {
  ...
  const title = pathname.startsWith("/settings") ? t("settings") : pathname.startsWith("/analyze") ? t("analyze") : pathname.startsWith("/profile-builder") ? "Profile Builder" : fallbackTitle;
