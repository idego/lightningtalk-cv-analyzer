...
export function AppHeader() {
  ...
  const title = pathname.startsWith("/settings") ? t("settings") : pathname.startsWith("/dashboard") ? t("dashboard") : pathname.startsWith("/analyze") ? t("analyze") : pathname.startsWith("/manual") ? t("manual") : fallbackTitle;
