...
const copy = {
  en: {
    ...
    newGroupName: "e.g. Junior backend engineer", groupName: "Group name", createGroupDescription: "Groups collect the analyses for one job offer.", selectGroup: "Select a group…", createGroup: "Create group", creatingGroup: "Creating...", groupCouldNotCreate: "The group could not be created.", groupsUnavailable: "Analysis groups are unavailable.",
    deleteGroup: "Delete group", deleteGroupTitle: "Delete group?", deleteGroupDescription: "This permanently deletes the group \"{name}\" together with its {count} analyses and stored CVs. This action cannot be undone.", clearUnassignedGroupDescription: "This permanently deletes all {count} analyses without a group and their stored CVs. This action cannot be undone.", groupCouldNotDelete: "The group could not be deleted.",
  ...
  pl: {
    ...
    newGroupName: "np. Junior backend engineer", groupName: "Nazwa grupy", createGroupDescription: "Grupa zbiera analizy dla jednej oferty pracy.", selectGroup: "Wybierz grupę…", createGroup: "Utwórz grupę", creatingGroup: "Tworzenie...", groupCouldNotCreate: "Nie udało się utworzyć grupy.", groupsUnavailable: "Grupy analiz są niedostępne.",
    deleteGroup: "Usuń grupę", deleteGroupTitle: "Usunąć grupę?", deleteGroupDescription: "Trwale usuwa grupę \"{name}\" wraz z {count} analizami i zapisanymi CV. Tej operacji nie można cofnąć.", clearUnassignedGroupDescription: "Trwale usuwa wszystkie {count} analiz bez grupy i ich zapisane CV. Tej operacji nie można cofnąć.", groupCouldNotDelete: "Nie udało się usunąć grupy.",
