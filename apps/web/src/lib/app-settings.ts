...
const copy = {
  en: {
    ...
    showCv: "Show CV", hideCv: "Hide CV", copyAnalysisLink: "Copy link", copyingAnalysisLink: "Copying...", analysisLinkCopied: "Link copied (valid 2 days)", analysisLinkCopyFailed: "Copy failed", loadingAnalysis: "Loading analysis...", unsupportedFiles: "Unsupported files: {names}. Use PDF or DOCX.",
    ...
    recentAnalyses: "Recent analyses", noHistory: "No analyses yet.", noHistoryDescription: "Completed CV analyses will appear here.", loadingHistory: "Loading recent analyses…", showMoreAnalyses: "Show more ({count})", showFewerAnalyses: "Show fewer",
    ...
    dataRetention: "Data retention", keepFor: "Keep completed analyses for", days: "days", save: "Save", retentionGlobalDescription: "Retention is deployment-wide and applies to analyses saved from now on; existing analyses keep their original deadline.", retentionOwnerOnly: "Only a feedback owner can change deployment-wide retention.", confirmRetentionChange: "Change global retention?", retentionGlobalConfirm: "Set the deployment-wide retention window to {days} days? Analyses saved from now on, for every user, will be deleted after that time.",
    deleteAll: "Delete your analyses", confirmDeleteAll: "Delete my analyses", deleteAllDescription: "This permanently deletes all analyses and CV files saved by your account. Other users' data will not be affected. Usage statistics will remain unchanged. This action cannot be undone.", deleting: "Deleting...",
    ...
    needsAttention: "Needs attention", worthKnowing: "Worth knowing", noEntriesFound: "No entries were found in the CV.", sectionAnalysisFailed: "This section could not be analyzed.", sectionUnresolved: "This section could not be resolved confidently.", reportAiCost: "Estimated report AI cost",
    feedbackLocationResolved: "Declared city and country resolved", feedbackLocationAmbiguous: "Declared location is ambiguous", feedbackLocationUnresolved: "Declared location not confirmed", feedbackLocationMismatch: "Declared city and country mismatch", feedbackPhoneCountryMismatch: "Declared country and phone country differ", feedbackEmailTypo: "Possible email-domain typo", feedbackMissingCvInformation: "Missing CV information", feedbackUnconfirmedEntry: "Unconfirmed CV entry", feedbackResultNumber: "Result {index}", feedbackProfileNumber: "Profile {index}",
    extracted: "CV overview", whyItMatters: "Why it matters", whatToCheck: "What to check", evidence: "Evidence",
    contact: "Contact", candidateName: "Candidate name", phoneNumber: "Phone number", emailAddress: "Email address", linkedinLink: "LinkedIn", githubLink: "GitHub", personalLink: "Personal website", opensInNewTab: "Opens in a new tab", linkedinProvidedInContact: "A LinkedIn profile is already listed in the Contact section. Click again to search anyway.", location: "Location",
    statedLocation: "Stated location", resolvedLocation: "Resolved location", euStatus: "EU status",
    ...
    signOut: "Sign out", toggleTheme: "Toggle theme",
    ...
    viewSources: "View sources ({count})", searchDetails: "Search details", searchesAndLimitations: "Search details", search: "Search", limit: "Limit", searchWithGoogle: "Search with Google", searchSubjectWithGoogle: "Search {subject} with Google", searchLinkedIn: "Search on LinkedIn", searchLinkedInFor: "Search LinkedIn for {subject}",
  ...
  pl: {
    ...
    showCv: "Pokaż CV", hideCv: "Ukryj CV", copyAnalysisLink: "Kopiuj link", copyingAnalysisLink: "Kopiowanie...", analysisLinkCopied: "Skopiowano link (ważny 2 dni)", analysisLinkCopyFailed: "Nie udało się skopiować", loadingAnalysis: "Ładowanie analizy...", unsupportedFiles: "Nieobsługiwane pliki: {names}. Użyj PDF lub DOCX.",
    ...
    recentAnalyses: "Ostatnie analizy", noHistory: "Brak analiz.", noHistoryDescription: "Ukończone analizy CV pojawią się tutaj.", loadingHistory: "Ładowanie ostatnich analiz…", showMoreAnalyses: "Pokaż więcej ({count})", showFewerAnalyses: "Pokaż mniej",
    ...
    dataRetention: "Retencja danych", keepFor: "Przechowuj ukończone analizy przez", days: "dni", save: "Zapisz", retentionGlobalDescription: "Retencja jest globalna dla wdrożenia i dotyczy analiz zapisanych od teraz; istniejące analizy zachowują swój dotychczasowy termin.", retentionOwnerOnly: "Tylko właściciel feedbacku może zmienić globalną retencję.", confirmRetentionChange: "Zmienić globalną retencję?", retentionGlobalConfirm: "Ustawić globalny okres retencji na {days} dni? Analizy wszystkich użytkowników zapisane od teraz będą usuwane po tym czasie.",
    deleteAll: "Usuń swoje analizy", confirmDeleteAll: "Usuń moje analizy", deleteAllDescription: "To trwale usunie wszystkie analizy i pliki CV zapisane na Twoim koncie. Dane innych użytkowników pozostaną bez zmian. Statystyki użycia nie zostaną wyzerowane. Tej operacji nie można cofnąć.", deleting: "Usuwanie...",
    ...
    needsAttention: "Wymaga uwagi", worthKnowing: "Warto wiedzieć", noEntriesFound: "Nie znaleziono wpisów w CV.", sectionAnalysisFailed: "Nie udało się przeanalizować tej sekcji.", sectionUnresolved: "Nie udało się jednoznacznie ustalić zawartości tej sekcji.", reportAiCost: "Szacowany koszt AI raportu",
    feedbackLocationResolved: "Rozpoznano deklarowane miasto i kraj", feedbackLocationAmbiguous: "Deklarowana lokalizacja jest niejednoznaczna", feedbackLocationUnresolved: "Nie potwierdzono deklarowanej lokalizacji", feedbackLocationMismatch: "Deklarowane miasto i kraj są niespójne", feedbackPhoneCountryMismatch: "Deklarowany kraj i kraj numeru telefonu są różne", feedbackEmailTypo: "Możliwa literówka w domenie e-mail", feedbackMissingCvInformation: "Brakujące informacje w CV", feedbackUnconfirmedEntry: "Niepotwierdzony wpis w CV", feedbackResultNumber: "Wynik {index}", feedbackProfileNumber: "Profil {index}",
    extracted: "Podsumowanie CV", whyItMatters: "Dlaczego to ważne", whatToCheck: "Co sprawdzić", evidence: "Dowód",
    contact: "Kontakt", candidateName: "Imię i nazwisko kandydata", phoneNumber: "Numer telefonu", emailAddress: "Adres e-mail", linkedinLink: "LinkedIn", githubLink: "GitHub", personalLink: "Strona osobista", opensInNewTab: "Otwiera się w nowej karcie", linkedinProvidedInContact: "Profil LinkedIn jest już podany w sekcji Kontakt. Kliknij ponownie, aby mimo to wyszukać.", location: "Lokalizacja",
    statedLocation: "Deklarowana lokalizacja", resolvedLocation: "Rozpoznana lokalizacja", euStatus: "Status UE",
    ...
    signOut: "Wyloguj się", toggleTheme: "Przełącz motyw",
