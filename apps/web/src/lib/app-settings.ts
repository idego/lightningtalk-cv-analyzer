...
const copy = {
  en: {
    ...
    deleteAll: "Delete all analyses", confirmDeleteAll: "Delete all", deleteAllDescription: "This permanently deletes every saved analysis and stored CV. This action cannot be undone.", cancel: "Cancel", deleting: "Deleting...",
  ...
  pl: {
    ...
    deleteAll: "Usuń wszystkie analizy", confirmDeleteAll: "Usuń wszystkie", deleteAllDescription: "To trwale usunie wszystkie zapisane analizy i przechowywane pliki CV. Tej operacji nie można cofnąć.", cancel: "Anuluj", deleting: "Usuwanie...",
