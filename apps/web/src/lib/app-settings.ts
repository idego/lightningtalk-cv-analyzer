...
const copy = {
  en: {
    ...
    contact: "Contact", candidateName: "Candidate name", phoneNumber: "Phone number", emailAddress: "Email address", linkedinLink: "LinkedIn", githubLink: "GitHub", personalLink: "Personal website", opensInNewTab: "Opens in a new tab", location: "Location",
  ...
  pl: {
    ...
    contact: "Kontakt", candidateName: "Imię i nazwisko kandydata", phoneNumber: "Numer telefonu", emailAddress: "Adres e-mail", linkedinLink: "LinkedIn", githubLink: "GitHub", personalLink: "Strona osobista", opensInNewTab: "Otwiera się w nowej karcie", location: "Lokalizacja",
