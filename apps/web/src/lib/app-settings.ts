...
const copy = {
  en: {
    ...
    newGroupName: "New group name, e.g. Junior backend engineer", createGroup: "Create group", creatingGroup: "Creating...", groupCouldNotCreate: "The group could not be created.", groupsUnavailable: "Analysis groups are unavailable.",
    ...
    analysisGroup: "Analysis group", moveToGroup: "Move to group", movingToGroup: "Moving...", analysisCouldNotMove: "The analysis could not be moved.", analysisGroupHint: "Every CV in this batch is added to the selected group.", newGroupOption: "New group...", loadingGroups: "Loading groups…",
  ...
  pl: {
    ...
    newGroupName: "Nazwa nowej grupy, np. Junior backend engineer", createGroup: "Utwórz grupę", creatingGroup: "Tworzenie...", groupCouldNotCreate: "Nie udało się utworzyć grupy.", groupsUnavailable: "Grupy analiz są niedostępne.",
    ...
    analysisGroup: "Grupa analiz", moveToGroup: "Przenieś do grupy", movingToGroup: "Przenoszenie...", analysisCouldNotMove: "Nie udało się przenieść analizy.", analysisGroupHint: "Każde CV z tej partii zostanie dodane do wybranej grupy.", newGroupOption: "Nowa grupa...", loadingGroups: "Ładowanie grup…",
