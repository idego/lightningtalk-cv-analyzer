...
const copy = {
  en: {
    ...
    outsideEu: "Outside the EU", insideEu: "Inside the EU", education: "Education", educationEntry: "Education entry", experience: "Experience", employmentEntry: "Employment entry", skills: "Explicit skills", explicitSkill: "Code-owned ESCO skill",
    recordSourceCode: "Code-owned", recordSourceAi: "AI-added", recordAiEnrichment: "AI enrichment", recordConflict: "Conflict", recordUnknownFields: "Unknown fields", recordCodeValue: "Code", recordAiValue: "AI",
    ...
    viewSources: "View sources ({count})", sourceNumber: "Source {index}", searchDetails: "Search details", searchesAndLimitations: "Searches and limitations", search: "Search", limit: "Limit", searchWithGoogle: "Search with Google", searchSubjectWithGoogle: "Search {subject} with Google",
  ...
  pl: {
    ...
    outsideEu: "Poza UE", insideEu: "W UE", education: "Edukacja", educationEntry: "Wpis edukacyjny", experience: "Doświadczenie", employmentEntry: "Wpis zatrudnienia", skills: "Jawne umiejętności", explicitSkill: "Umiejętność ESCO rozpoznana przez kod",
    recordSourceCode: "Rozpoznane przez kod", recordSourceAi: "Dodane przez AI", recordAiEnrichment: "Uzupełnienie AI", recordConflict: "Sprzeczność", recordUnknownFields: "Nieznane pola", recordCodeValue: "Kod", recordAiValue: "AI",
    ...
    viewSources: "Pokaż źródła ({count})", sourceNumber: "Źródło {index}", searchDetails: "Szczegóły wyszukiwania", searchesAndLimitations: "Wyszukiwania i ograniczenia", search: "Wyszukiwanie", limit: "Ograniczenie", searchWithGoogle: "Wyszukaj w Google", searchSubjectWithGoogle: "Wyszukaj {subject} w Google",
