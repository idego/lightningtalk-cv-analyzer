...
const copy = {
  en: {
    ...
    analysesTitle: "Analyses", analysesDescription: "Every saved analysis, grouped by job offer. Analyses without a group are listed under Rest.", restGroup: "Rest", restGroupDescription: "Analyses without a group", analysesInGroup: "{count} analyses", noAnalysesInGroup: "No analyses in this group yet.", collapseGroup: "Collapse {name}", expandGroup: "Expand {name}",
    ...
    deleteGroup: "Delete group", deleteGroupTitle: "Delete group?", deleteGroupDescription: "This permanently deletes the group \"{name}\" together with its {count} analyses and stored CVs. This action cannot be undone.", clearRestGroupDescription: "This permanently deletes all {count} analyses without a group and their stored CVs. This action cannot be undone.", groupCouldNotDelete: "The group could not be deleted.",
    analysisGroup: "Analysis group", analysisGroupHint: "Every CV in this batch is added to the selected group.", newGroupOption: "New group...", loadingGroups: "Loading groups…",
  ...
  pl: {
    ...
    analysesTitle: "Analizy", analysesDescription: "Wszystkie zapisane analizy pogrupowane według ofert. Analizy bez grupy trafiają do grupy Pozostałe.", restGroup: "Pozostałe", restGroupDescription: "Analizy bez grupy", analysesInGroup: "{count} analiz", noAnalysesInGroup: "Ta grupa nie ma jeszcze analiz.", collapseGroup: "Zwiń {name}", expandGroup: "Rozwiń {name}",
    ...
    deleteGroup: "Usuń grupę", deleteGroupTitle: "Usunąć grupę?", deleteGroupDescription: "Trwale usuwa grupę \"{name}\" wraz z {count} analizami i zapisanymi CV. Tej operacji nie można cofnąć.", clearRestGroupDescription: "Trwale usuwa wszystkie {count} analiz bez grupy i ich zapisane CV. Tej operacji nie można cofnąć.", groupCouldNotDelete: "Nie udało się usunąć grupy.",
    analysisGroup: "Grupa analiz", analysisGroupHint: "Każde CV z tej partii zostanie dodane do wybranej grupy.", newGroupOption: "Nowa grupa...", loadingGroups: "Ładowanie grup…",
