...
const copy = {
  en: {
    ...
    needsAttention: "Needs attention", worthKnowing: "Worth knowing", needsReview: "Needs review", noEntriesFound: "No entries were found in the CV.", sectionAnalysisFailed: "This section could not be analyzed.", sectionUnresolved: "This section could not be resolved confidently.", reportAiCost: "Estimated report AI cost",
