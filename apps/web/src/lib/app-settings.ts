...
const copy = {
  en: {
    ...
    dataRetention: "Data retention", keepFor: "Keep completed analyses and recent profiles for", days: "days", save: "Save",
  ...
  pl: {
    ...
    dataRetention: "Retencja danych", keepFor: "Przechowuj ukończone analizy i ostatnie profile przez", days: "dni", save: "Zapisz",
