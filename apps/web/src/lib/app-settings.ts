...
const copy = {
  en: {
    ...
    start: "Run research", researching: "Researching…", discovering: "Searching…", companyResearchInProgress: "Company research in progress", educationResearchInProgress: "Education research in progress", linkedinDiscoveryInProgress: "LinkedIn discovery in progress", researchTimedOut: "Research timed out. You can safely try again.", researchFailed: "Research failed. Try again or check System health.", automaticResearchFailed: "Automatic research failed. You can try again manually.", automaticResearchAlreadyAttempted: "Automatic research was already attempted. Use the manual action to try again.",
