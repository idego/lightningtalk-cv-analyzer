...
const copy = {
  en: {
    ...
    linkedinProfiles: "LinkedIn profile research", startDiscovery: "Start", noProfileFound: "No profile found", severalPossibleMatches: "Several possible matches. Review required.", openProfile: "Open profile", profile: "Profile {index}", photoVisible: "Photo visible", noPublicPhoto: "No public photo", photoUnknown: "Photo unknown", lowConnectionCount: "Low connection count", connections: "Connections: {count}", connectionsUnknown: "Connections unknown",
