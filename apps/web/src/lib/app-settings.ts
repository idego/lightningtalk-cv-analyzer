...
const copy = {
  en: {
    ...
    analysesTitle: "Analyses", analysesDescription: "Your saved analyses, grouped by job offer. Groups and analyses are private to the user who created them; other recruiters cannot see them. Analyses without a group are listed under Unassigned.", unassignedGroup: "Unassigned", unassignedGroupDescription: "Analyses not assigned to any offer", analysesInGroup: "{count} analyses", noAnalysesInGroup: "No analyses in this group yet.", collapseGroup: "Collapse {name}", expandGroup: "Expand {name}",
  ...
  pl: {
    ...
    analysesTitle: "Analizy", analysesDescription: "Twoje zapisane analizy pogrupowane według ofert. Grupy i analizy są prywatne dla użytkownika, który je utworzył; inni rekruterzy ich nie widzą. Analizy bez grupy trafiają do grupy Nieprzypisane.", unassignedGroup: "Nieprzypisane", unassignedGroupDescription: "Analizy nieprzypisane do żadnej oferty", analysesInGroup: "{count} analiz", noAnalysesInGroup: "Ta grupa nie ma jeszcze analiz.", collapseGroup: "Zwiń {name}", expandGroup: "Rozwiń {name}",
    ...
    analysisGroup: "Grupa analiz", moveToGroup: "Przenieś do grupy", movingToGroup: "Przenoszenie...", analysisCouldNotMove: "Nie udało się przenieść analizy.", analysisGroupHint: "Każde CV z tej partii zostanie dodane do wybranej grupy. Bez wyboru partia pozostaje nieprzypisana.", newGroupOption: "Nowa grupa...", loadingGroups: "Ładowanie grup…",
