...
const copy = {
  en: {
    ...
    queued: "Queued files", valid: "valid", analyzeFiles: "Analyze files", reset: "Reset", cancel: "Cancel", removeFile: "Remove {name}",
  ...
  pl: {
    ...
    queued: "Pliki w kolejce", valid: "poprawnych", analyzeFiles: "Analizuj pliki", reset: "Wyczyść", cancel: "Anuluj", removeFile: "Usuń {name}",
