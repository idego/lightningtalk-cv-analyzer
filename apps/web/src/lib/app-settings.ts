...
const copy = {
  en: {
    ...
    database: "Database", geoNamesResolver: "GeoNames location resolver", baseAnalysis: "Base analysis strategy", linkedinResearch: "LinkedIn research",
  ...
  pl: {
    ...
    database: "Baza danych", geoNamesResolver: "Resolver lokalizacji GeoNames", baseAnalysis: "Strategia analizy bazowej", linkedinResearch: "Wyszukiwanie LinkedIn",
