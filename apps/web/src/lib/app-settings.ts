...
const copy = {
  en: {
    ...
    showCv: "Show CV", hideCv: "Hide CV", copyAnalysisLink: "Copy link", copyingAnalysisLink: "Copying...", analysisLinkCopied: "Link copied", analysisLinkCopyFailed: "Copy failed", loadingAnalysis: "Loading analysis...",
  ...
  pl: {
    ...
    showCv: "Pokaż CV", hideCv: "Ukryj CV", copyAnalysisLink: "Kopiuj link", copyingAnalysisLink: "Kopiowanie...", analysisLinkCopied: "Skopiowano link", analysisLinkCopyFailed: "Nie udało się skopiować", loadingAnalysis: "Ładowanie analizy...",
