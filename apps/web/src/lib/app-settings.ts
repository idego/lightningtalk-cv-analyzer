...
const copy = {
  en: {
    ...
    recentAnalyses: "Recent analyses", noHistory: "No analyses yet.", noHistoryDescription: "Completed CV analyses will appear here.", historyOwnerOnly: "Only your analyses are shown.", loadingHistory: "Loading recent analyses…", partialAnalysis: "Partial", showMoreAnalyses: "Show more ({count})", showFewerAnalyses: "Show fewer",
    originalNotRetained: "The original CV was not retained.", documentFetchFailed: "The stored CV could not be loaded.", deleteAnalysis: "Delete analysis", deleteAnalysisEllipsis: "Delete analysis…", analysisActions: "More actions", deleteAnalysisTitle: "Delete analysis?", deleteAnalysisDescription: "The analysis for \"{name}\", its stored CV and note will be permanently deleted. This action is irreversible.",
    analysesTitle: "Analyses", analysesDescription: "Your saved analyses, grouped by job offer. Analyses without a group are listed under Unassigned.\nGroups and analyses are private to the user who created them; other recruiters cannot see them.", unassignedGroup: "Unassigned", unassignedGroupDescription: "Analyses not assigned to any offer", analysesInGroup: "{count} analyses", noAnalysesInGroup: "No analyses in this group yet.", collapseGroup: "Collapse {name}", expandGroup: "Expand {name}",
    newGroupName: "e.g. Junior backend engineer", groupName: "Group name", createGroupDescription: "Groups collect the analyses for one job offer.", selectGroup: "Select a group…", createGroup: "Create group", creatingGroup: "Creating...", groupCouldNotCreate: "The group could not be created.", groupNameTaken: "A group with this name already exists.", groupsUnavailable: "Analysis groups are unavailable.",
    deleteGroup: "Delete group", deleteGroupTitle: "Delete group \"{name}\"?", deleteGroupDescription: "All {count} analyses assigned to this group, together with their stored CVs, will be permanently deleted. This action is irreversible.", clearUnassignedGroupTitle: "Delete all unassigned analyses?", clearUnassignedGroupDescription: "All {count} unassigned analyses, together with their stored CVs, will be permanently deleted. This action is irreversible.", groupCouldNotDelete: "The group could not be deleted.",
    addNote: "Add note", editNote: "Edit note", noteTitle: "Note: {name}", noteDescription: "Private to you. Notes are deleted together with the analysis.", notePlaceholder: "Screening remarks, follow-ups, interview impressions…", loadingNote: "Loading note…", deleteNote: "Delete note", noteUpdated: "Last saved {time}", noteTooLong: "Notes are limited to {max} characters.", noteUnavailable: "The note could not be loaded.", noteCouldNotSave: "The note could not be saved.", noteCouldNotDelete: "The note could not be deleted.", analysisGroup: "Analysis group", moveToGroup: "Move to group", movingToGroup: "Moving...", analysisCouldNotMove: "The analysis could not be moved.", analysisGroupHint: "Every CV in this batch is added to the selected group. Without a selection the batch stays unassigned.", newGroupOption: "New group...", loadingGroups: "Loading groups…",
  ...
  pl: {
    ...
    recentAnalyses: "Ostatnie analizy", noHistory: "Brak analiz.", noHistoryDescription: "Ukończone analizy CV pojawią się tutaj.", historyOwnerOnly: "Widoczne są tylko Twoje analizy.", loadingHistory: "Ładowanie ostatnich analiz…", partialAnalysis: "Częściowa", showMoreAnalyses: "Pokaż więcej ({count})", showFewerAnalyses: "Pokaż mniej",
    originalNotRetained: "Oryginalny plik CV nie został zachowany.", documentFetchFailed: "Nie udało się wczytać zapisanego CV.", deleteAnalysis: "Usuń analizę", deleteAnalysisEllipsis: "Usuń analizę…", analysisActions: "Więcej akcji", deleteAnalysisTitle: "Usunąć analizę?", deleteAnalysisDescription: "Analiza dla \"{name}\" wraz z zapisanym CV i notatką zostanie trwale usunięta. Tej operacji nie można cofnąć.",
    analysesTitle: "Analizy", analysesDescription: "Twoje zapisane analizy pogrupowane według ofert. Analizy bez grupy trafiają do grupy Nieprzypisane.\nGrupy i analizy są prywatne dla użytkownika, który je utworzył; inni rekruterzy ich nie widzą.", unassignedGroup: "Nieprzypisane", unassignedGroupDescription: "Analizy nieprzypisane do żadnej oferty", analysesInGroup: "{count} analiz", noAnalysesInGroup: "Ta grupa nie ma jeszcze analiz.", collapseGroup: "Zwiń {name}", expandGroup: "Rozwiń {name}",
    newGroupName: "np. Junior backend engineer", groupName: "Nazwa grupy", createGroupDescription: "Grupa zbiera analizy dla jednej oferty pracy.", selectGroup: "Wybierz grupę…", createGroup: "Utwórz grupę", creatingGroup: "Tworzenie...", groupCouldNotCreate: "Nie udało się utworzyć grupy.", groupNameTaken: "Grupa o tej nazwie już istnieje.", groupsUnavailable: "Grupy analiz są niedostępne.",
    deleteGroup: "Usuń grupę", deleteGroupTitle: "Usunąć grupę \"{name}\"?", deleteGroupDescription: "Wszystkie {count} analizy przypisane do tej grupy wraz z zapisanymi CV zostaną trwale usunięte. Tej operacji nie można cofnąć.", clearUnassignedGroupTitle: "Usunąć wszystkie nieprzypisane analizy?", clearUnassignedGroupDescription: "Wszystkie {count} nieprzypisane analizy wraz z zapisanymi CV zostaną trwale usunięte. Tej operacji nie można cofnąć.", groupCouldNotDelete: "Nie udało się usunąć grupy.",
    addNote: "Dodaj notatkę", editNote: "Edytuj notatkę", noteTitle: "Notatka: {name}", noteDescription: "Widoczna tylko dla Ciebie. Notatki są usuwane razem z analizą.", notePlaceholder: "Uwagi ze screeningu, kolejne kroki, wrażenia z rozmowy…", loadingNote: "Ładowanie notatki…", deleteNote: "Usuń notatkę", noteUpdated: "Ostatnio zapisano {time}", noteTooLong: "Notatka może mieć najwyżej {max} znaków.", noteUnavailable: "Nie udało się wczytać notatki.", noteCouldNotSave: "Nie udało się zapisać notatki.", noteCouldNotDelete: "Nie udało się usunąć notatki.", analysisGroup: "Grupa analiz", moveToGroup: "Przenieś do grupy", movingToGroup: "Przenoszenie...", analysisCouldNotMove: "Nie udało się przenieść analizy.", analysisGroupHint: "Każde CV z tej partii zostanie dodane do wybranej grupy. Bez wyboru partia pozostaje nieprzypisana.", newGroupOption: "Nowa grupa...", loadingGroups: "Ładowanie grup…",
