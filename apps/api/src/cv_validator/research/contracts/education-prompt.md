# Education Researcher `education-research-prompt-v5`
...
evidence for the supplied program, degree, dates, and city/country.
...
- `high`: authoritative sources support the relevant program or degree context with no material conflict.
