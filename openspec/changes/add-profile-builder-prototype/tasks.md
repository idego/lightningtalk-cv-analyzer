...
## 3. Frontend workflow
- [ ] 3.1 Add authenticated proxy routes, sidebar destination, and `/profile-builder` page.
- [ ] 3.2 Add upload/extraction state, canonical editor, anonymization controls, live preview, and DOCX download.

## 4. Verification
- [x] 4.1 Add domain/API regression tests covering schema, national-ID redaction, anonymization, and stale-state export.
- [ ] 4.2 Run backend tests plus frontend typecheck/lint/unit tests and a production build under supported Node 22.
- [ ] 4.3 Review the completed diff against repository standards and this change spec.
