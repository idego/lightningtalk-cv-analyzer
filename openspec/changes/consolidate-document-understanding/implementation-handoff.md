...
- Backend: 551 tests passed in the rebuilt Docker test image; one upstream
...
- Real UI: an isolated synthetic-only stack rendered code-owned education,
...
uses only offline reviewed ESCO data at runtime, and adds no OCR, service, or
