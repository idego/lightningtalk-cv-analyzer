...
**Reason**: This calibration has now been approved and implemented through
versioned deterministic phone-country and eligible postal-country comparisons.
The project no longer needs a requirement that limits this work to a proposal.
