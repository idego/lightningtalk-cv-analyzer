# linkedin-manual-search Specification

## Purpose
Defines the single recruiter-initiated LinkedIn people search derived from
accepted candidate evidence without mutating analysis or research state.
