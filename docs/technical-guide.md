...
Detailed analysis, runtime, and data-handling reference. For an overview and quick start, see the [README](../README.md).
...
See the current [architecture](architecture.md) for durable boundaries and
...
[`docs/reference-data/geonames.md`](reference-data/geonames.md) for recovery,
